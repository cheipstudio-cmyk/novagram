package com.secondream.novamessenger.ui.theme
...
object AccentPalette {
    ...
    val Rose = Accent(
        ...
        primaryDeep = Color(0xFFC2667C),
        onPrimary = Color(0xFF1F0E13)
    )
    val Cyan = Accent(
        primary = Color(0xFF5BC0BE),
        primaryDeep = Color(0xFF3A9694),
        onPrimary = Color(0xFF0A1818)
    )
    val Orange = Accent(
        primary = Color(0xFFE89B5A),
        primaryDeep = Color(0xFFC67A38),
        onPrimary = Color(0xFF1F1308)
    )
}
...
object BubblePalette {
    ...
    val Cyan   = BubbleFill(Color(0xFF173030), Color(0xFFD5E8E7))
    val Orange = BubbleFill(Color(0xFF3A2613), Color(0xFFEFDFCB))
}
